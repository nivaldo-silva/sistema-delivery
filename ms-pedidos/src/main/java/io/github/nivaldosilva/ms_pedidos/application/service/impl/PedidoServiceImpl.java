package io.github.nivaldosilva.ms_pedidos.application.service.impl;
...
import io.github.nivaldosilva.ms_pedidos.domain.entity.ItemPedido;
import io.github.nivaldosilva.ms_pedidos.domain.entity.Pedido;
import io.github.nivaldosilva.ms_pedidos.domain.enums.StatusPedido;
import io.github.nivaldosilva.ms_pedidos.application.exception.RegraNegocioException;
import io.github.nivaldosilva.ms_pedidos.application.exception.RecursoNaoEncontradoException;
import io.github.nivaldosilva.ms_pedidos.application.mapper.PedidoMapper;
import io.github.nivaldosilva.ms_pedidos.infrastructure.repository.PedidoRepository;
import io.github.nivaldosilva.ms_pedidos.application.service.PedidoService;
...
public class PedidoServiceImpl implements PedidoService {
    ...
    public PedidoResponse atualizarPedido(UUID id, PedidoRequest request) {
        ...
        if (pedido.getStatusPedido() != StatusPedido.REALIZADO) {
            throw new RegraNegocioException("Apenas pedidos com status 'REALIZADO' podem ser alterados");
        }
